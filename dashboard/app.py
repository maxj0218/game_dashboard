...
def overview_page():
    ...
    col2.metric("Average owners", f"{avg_owners:,.0f}")
    col3.metric("Average user score", f"{avg_score:.1f}")
    col4.metric("Average peak CCU", f"{avg_ccu:,.0f}")
...
def modeling_page():
    ...
    col2.dataframe(report_df.loc[['0', '1', 'accuracy']][['precision', 'recall', 'f1-score']])
